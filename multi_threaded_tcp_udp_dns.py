...
class UDP_RequestHandler(socketserver.BaseRequestHandler):
    def handle(self):
...
if __name__ == "__main__":
    with socketserver.ThreadingTCPServer(
        ("0.0.0.0", 5000), TCP_RequestHandler
    ) as tcpserver, socketserver.UDPServer(("0.0.0.0", 5000), UDP_RequestHandler) as udpserver:
